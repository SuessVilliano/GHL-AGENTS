        ...
        <div className={`flex flex-col h-screen ${isDark ? 'dark bg-slate-900 text-white' : 'bg-white text-slate-900'} transition-colors duration-300`}>
            ...
            <div className="p-4 border-t border-white/10 bg-opacity-90 backdrop-blur-md">
                ...
                <div className="flex justify-center mt-3 gap-4">
                    <button onClick={() => window.open('https://dashboard-standalone.vercel.app/dashboard', '_blank')} className="text-[10px] font-bold text-slate-400 hover:text-blue-500 uppercase tracking-widest transition-colors flex items-center gap-1">
                        Open Dashboard
                    </button>
                    <button onClick={() => window.open('https://dashboard-standalone.vercel.app/onboarding', '_blank')} className="text-[10px] font-bold text-slate-400 hover:text-blue-500 uppercase tracking-widest transition-colors flex items-center gap-1">
                        Help & Setup
                    </button>
                </div>
            </div>
